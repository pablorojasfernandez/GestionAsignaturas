...
public class ControladorCurso {
     ...
     *
     * @param cursoActual curso que se quiere eliminar.
     */
    public void eliminarCurso(int cursoActual) {
     ...
     *
     * @param cursoActual nuevo curso actual.
     */
    public void nuevoCursoActual(int cursoActual) {
     ...
     *  su flag "actual".
     *
     * @param cursoActual curso actual (que se va a desactivar).
     */
    public void desactivarCursoActual(int cursoActual) {
        StringBuilder sql = new StringBuilder("UPDATE CURSO "
                                            + "SET actual = 0 "
                                            + "WHERE (Cod_CURSO = ?)");
        DataAccessObject dataAccessObject = DataAccessObject.getDataAccessObjectConnected();
